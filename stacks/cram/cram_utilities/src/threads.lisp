...
;;; We use this hook in the test suite to be able to collect all task
;;; threads spawned during the extent of a test run.
(defvar *make-thread-function* 'sb-thread:make-thread)

(defun spawn-thread (name function &rest args)
  (funcall *make-thread-function*
