...
SupportingPlanerDescriptor::SupportingPlanerDescriptor(Class* cl) :
    Descriptor(cl),
    m_extX(0.1),
    m_extY(0.1),
    m_marker(NULL)
...
SupportingPlanerDescriptor::SupportingPlanerDescriptor(XMLTag* node) :
    Descriptor(node)
{
    if(node != NULL)
    {
...
SupportingPlanerDescriptor::~SupportingPlanerDescriptor(void)
{
}

void SupportingPlanerDescriptor::Show(Camera* cam)
{
    return;
}


void SupportingPlanerDescriptor::SaveTo(XMLTag* tag)
{
