...
public:
  ...
  virtual Descriptor* Perform(std::vector<Camera*> cam, RelPose* pose, Signature& sig, int &numOfObjects, double& qualityMeasure);

  virtual double CheckSignature(Signature& sig);
