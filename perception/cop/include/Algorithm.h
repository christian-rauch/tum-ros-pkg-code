...
public:
	...
	*	@param camera a list of cameras that look at the specified position
	...
	*	@returns An instanz of T
	*/
	virtual T Perform(std::vector<Camera*> cam, RelPose* pose, Signature& object, int &numOfObjects, double& qualityMeasure) = 0;
	/**
	*	CheckSignature
	...
	*	@return the number of images that should be passed to this algorithm at once
	*/
	virtual int NumberOfImagesNeeded(){return 1;}
	/**
