...
public:
   ...
   ***************************************************/
    NetworkCamera (XMLTag* stConfigFile );
    /**
    *  Get Type of the camera by its Name
    */
    virtual std::string GetName(){return XML_NODE_NETWORKCAMERA;};
    /**
   * Empty Destructor
   */
    ...
    */
    ...
    virtual bool  CanSee(RelPose &pose);
    virtual double  LookAt(RelPose &pose);
