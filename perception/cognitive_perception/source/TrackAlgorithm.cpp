...
TrackAlgorithm::TrackAlgorithm (PerceptionPrimitive& sig, Algorithm<std::vector<RelPose*> > *alg,
 ...
 void TrackAlgorithm::threadfunc()
{
  ...
  RelPose* lastKnownPose = object.m_relPose;
  ...
  while(m_Running && !g_stopall)
  {
    ...
    lastKnownPose = object.m_relPose;
